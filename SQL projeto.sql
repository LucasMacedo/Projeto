...
CREATE  TABLE IF NOT EXISTS `tcc`.`ataque` (
  ...
  PRIMARY KEY (`id`) ,
  INDEX `fk_ataque_elemento1_idx` (`elemento` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `tcc`.`pokemon` (
  ...
  PRIMARY KEY (`id`) ,
  INDEX `fk_pokemon_ataque1_idx` (`idAtaque` ASC) ,
  INDEX `fk_pokemon_elemento1_idx` (`elementoPrimario` ASC) ,
  INDEX `fk_pokemon_elemento2_idx` (`elementoSecundario` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `tcc`.`evolucaoporpedra` (
  ...
  INDEX `fk_pokemon_has_pokemon_pokemon2_idx` (`idEvolucao` ASC) ,
  INDEX `fk_pokemon_has_pokemon_pokemon1_idx` (`idPokemon` ASC) ,
  INDEX `fk_evolucaoporpedra_elemento1_idx` (`elemento` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `tcc`.`pokemonderrotado` (
  ...
  PRIMARY KEY (`id`) ,
  INDEX `fk_PokemonDerrotado_pokemon1_idx` (`idPokemon` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `tcc`.`pokemonliberado` (
  ...
  INDEX `fk_jogador_has_pokemon_pokemon1_idx` (`idPokemon` ASC) ,
  INDEX `fk_jogador_has_pokemon_jogador_idx` (`idJogador` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `tcc`.`bonusDeElemento` (
  ...
  INDEX `fk_elemento_has_elemento_elemento2_idx` (`elementoMultiplicador` ASC) ,
  INDEX `fk_elemento_has_elemento_elemento1_idx` (`elemento` ASC) ,
